  ...
  const clusters = [
    {
      ...
      avgIPM: 76.8,
      avgInvestment: 80.5,
      provinces: ["DKI Jakarta", "Jawa Barat", "Jawa Tengah", "Jawa Timur", "DI Yogyakarta", "Bali"],
      characteristics: [
    ...
    },
    {
      ...
      avgIPM: 72.4,
      avgInvestment: 38.2,
      provinces: ["Sumatera Utara", "Riau", "Kepulauan Riau", "Banten", "Lampung", "Kalimantan Timur", "Sulawesi Utara", "Sulawesi Selatan", "dan 6 provinsi lainnya"],
      characteristics: [
    ...
    },
    {
      ...
      avgIPM: 68.2,
      avgInvestment: 12.8,
      provinces: ["Papua", "Papua Barat", "Maluku", "Maluku Utara", "Nusa Tenggara Timur", "Sulawesi Tengah", "Kalimantan Barat", "dan 7 provinsi lainnya"],
      characteristics: [
