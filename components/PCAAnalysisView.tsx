...
export function PCAAnalysisView() {
  const pcaSummary = [
    { component: "PC1", variance: "45.2%", description: "Komponen utama pertama menjelaskan indeks ekonomi dan investasi", color: "#DC2626" },
    { component: "PC2", variance: "28.7%", description: "Komponen kedua berkaitan dengan infrastruktur dan aksesibilitas", color: "#F9B233" },
    { component: "PC3", variance: "15.3%", description: "Komponen ketiga menjelaskan aspek pembangunan manusia", color: "#059669" },
    { component: "PC4", variance: "10.8%", description: "Komponen keempat menjelaskan variabel residual lainnya", color: "#6B7280" },
  ];
