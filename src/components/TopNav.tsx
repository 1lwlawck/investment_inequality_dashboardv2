      ...
      <div className="flex items-center gap-4">
        ...
        <div className="border-l-2 border-[#F9B233] pl-4">
          <div className="flex items-center gap-2">
            <h1 className="text-[#002C5F] text-xl leading-tight" style={{ fontWeight: 700 }}>
              INVESTRA
            </h1>
          </div>
          <p className="text-sm text-gray-600 mt-0.5" style={{ fontWeight: 500 }}>
          ...
          <DropdownMenuTrigger asChild>
            <button className="flex items-center gap-2 bg-gray-50 rounded-lg px-3 py-2 border border-gray-200 hover:bg-gray-100 transition-colors cursor-pointer">
              ...
              <div className="hidden md:block text-left">
                <p className="text-sm text-[#002C5F]" style={{ fontWeight: 600 }}>Admin Dashboard</p>
                <p className="text-xs text-gray-500" style={{ fontWeight: 400 }}>INVESTRA</p>
              </div>
            </button>
          </DropdownMenuTrigger>
